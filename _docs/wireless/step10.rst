...
route to the desired node, it sends a message backwards through a
...
R3. This detection and reconfiguration takes very little time. After the
...
simulation it is not significant, the number received packets still
